export const courses = [
  ...
  },
  {
    ...
    modules: [
      ...
      { id: 'aed-m2',  title: 'The Encoder-Decoder Architecture',              file: 'aed-m2.html',  description: 'Two RNNs, one handoff — the context vector, <sos>/<eos>, and autoregressive decoding.',                    readTime: 14 },
      { id: 'aed-m3',  title: 'Evaluating Translations — BLEU Score',          file: 'aed-m3.html',  description: 'N-gram precision, clipping against repetition, the brevity penalty, and the geometric-mean formula.',       readTime: 15 },
      { id: 'aed-m4',  title: 'Demonstration — Encoder-Decoder in PyTorch',    file: 'aed-m4.html',  description: 'Encoder/Decoder modules, teacher forcing, and greedy-decoding inference — Colab notebook linked.',         readTime: 16 },
      { id: 'aed-m5',  title: 'The Limitation of Encoder-Decoder — the Bottleneck', file: 'aed-m5.html', description: 'Why a fixed-size context vector degrades on long sentences, and why early tokens are lost first.',      readTime: 14 },
      { id: 'aed-m6',  title: 'Attention-Based Encoder-Decoder — the Idea',    file: 'aed-m6.html',  description: 'Keeping every encoder state instead of one; a fresh, step-specific context vector per output word.',       readTime: 14 },
      { id: 'aed-m7',  title: 'How Attention Works, Step by Step',             file: 'aed-m7.html',  description: 'The four-stage pipeline — score, normalize, combine, generate — and why softmax is non-negotiable.',        readTime: 15 },
      { id: 'aed-m8',  title: 'Training an Attention-Based Encoder-Decoder',   file: 'aed-m8.html',  description: 'End-to-end backpropagation with no separate alignment supervision, and the O(T_src·T_tgt) cost it adds.',   readTime: 15 },
      { id: 'aed-m9',  title: 'Demonstration — Attention Encoder-Decoder in PyTorch', file: 'aed-m9.html', description: 'The attention decoder wired in, and how little of the Module 4 training loop needs to change.',        readTime: 16 },
      { id: 'aed-m10', title: 'The Math of Attention — Context Vectors',       file: 'aed-m10.html', description: 'Dot/general/additive score functions, the variance argument for scaled dot-product, worked numeric example.', readTime: 20 },
      { id: 'aed-m11', title: 'Limitations of Attention-Based Encoder-Decoder', file: 'aed-m11.html', description: 'Still-sequential computation and O(T_src·T_tgt) cost — the two constraints self-attention removes next.',  readTime: 14 },
      { id: 'aed-quiz', title: 'Track Quiz — Attention & Encoder-Decoder Models', file: 'aed-quiz.html', description: '13 questions — BLEU by hand, context-vector numericals, teacher forcing, and score-function comparison.', readTime: 20 },
    ],
  },
  {
    id: 'transformers',
    ...
    modules: [
      { id: 'trf-m1', title: 'Intuition Behind a Transformer',            file: 'trf-m1.html', description: 'Self-attention vs cross-attention, and why every word starts generic and gets refined by context.',       readTime: 12 },
      { id: 'trf-m2', title: 'Encoder-Decoder in a Transformer',          file: 'trf-m2.html', description: 'Unmasked encoder self-attention, masked decoder self-attention, and where cross-attention fits.',       readTime: 14 },
      { id: 'trf-m3', title: 'Transformer Architecture, Walked Through an Example', file: 'trf-m3.html', description: 'Positional encoding, stacked blocks, and the linear+softmax head — one input traced end to end.', readTime: 16 },
      { id: 'trf-m4', title: 'The Math of Self-Attention',                file: 'trf-m4.html', description: 'Query/Key projections, scaled dot-product scores, and causal masking via -infinity before softmax.',   readTime: 18 },
      { id: 'trf-m5', title: 'Value Vectors and Word Context Through Attention', file: 'trf-m5.html', description: 'The Value projection, the additive Δe update, and the fix for the very first module’s bank problem.', readTime: 16 },
      { id: 'trf-m6', title: 'Multi-Head Attention',                      file: 'trf-m6.html', description: 'Why several small attention patterns beat one big one, the low-rank Value trick, and GPT-3’s scale.',   readTime: 16 },
  ...
  },
  {
    ...
    trackPath: 'vae',
    modules: [
      { id: 'vae-m1',   title: 'Compression, Autoencoders & Latent Space',        file: 'vae-m1.html',  description: 'Why a bottleneck forces a network to learn structure, the encoder/code/decoder anatomy, and an intuition-only introduction to KL divergence.', readTime: 14 },
      { id: 'vae-m2',   title: 'From Autoencoders to Variational Autoencoders',  file: 'vae-m2.html',  description: 'Why standard autoencoders fail as generative models: holes, dead zones, and the need for continuous probabilistic latent spaces.', readTime: 15 },
      { id: 'vae-m3',   title: 'The Probabilistic Framework',                     file: 'vae-m3.html', description: 'The generative story, why the marginal likelihood integral is intractable, and variational inference with q(z|x).', readTime: 16 },
      { id: 'vae-m4',   title: 'The Evidence Lower Bound (ELBO)',                 file: 'vae-m4.html', description: 'Maximising a computable lower bound, the reconstruction/KL split that becomes the loss, and the full derivation as optional depth.', readTime: 18 },
      { id: 'vae-m5',   title: 'Analytical KL Divergence for Gaussians',          file: 'vae-m5.html', description: 'Closed-form derivation of Gaussian KL divergence, and why neural network encoders predict log-variance log(σ²).', readTime: 16 },
      { id: 'vae-m6',   title: 'The Reparameterization Trick',                    file: 'vae-m6.html', description: 'The stochastic bottleneck, pathwise derivatives z = μ + σ ⊙ ε, and backpropagating gradients through latent distributions.', readTime: 16 },
      { id: 'vae-m7',   title: 'Reconstruction Loss & Likelihood Assumptions',   file: 'vae-m7.html', description: 'Bernoulli likelihood with BCE vs Gaussian likelihood with MSE, and avoiding the sum-vs-mean reduction scaling trap.', readTime: 15 },
      { id: 'vae-m8',   title: 'Demonstration — Variational Autoencoder in PyTorch', file: 'vae-m8.html', description: 'End-to-end PyTorch implementation: Encoder, Reparameterize, Decoder, custom ELBO loss, and training loop — Colab lab linked.', readTime: 18 },
      { id: 'vae-m9',   title: 'Latent Space Exploration & Manifold Generation',  file: 'vae-m9.html', description: '2D grid sampling, linear (lerp) vs spherical (slerp) interpolation, and vector arithmetic in latent space.', readTime: 16 },
      { id: 'vae-m10',  title: 'β-VAE & Disentangled Representations',           file: 'vae-m10.html', description: 'The information bottleneck principle, forcing independent generative factors, and diagnosing/preventing posterior collapse.', readTime: 18 },
      { id: 'vae-m11',  title: 'Conditional VAE (CVAE) & Modern Frontiers',       file: 'vae-m11.html', description: 'Targeted class generation p(x|z, y), discrete codebooks with VQ-VAE, and comparing VAEs vs GANs vs Diffusion models.', readTime: 18 },
  ...
  },
  {
    ...
    trackPath: 'gan',
    modules: [
      { id: 'gan-m1',   title: 'From Explicit to Implicit Density',            file: 'gan-m1.html',   description: 'Why a GAN never writes down p(x), and why pixel-wise reconstruction loss produces blur while an adversarial loss does not.', readTime: 14 },
      { id: 'gan-m2',   title: 'The Minimax Game — Generator & Discriminator', file: 'gan-m2.html',   description: 'The shared value function V(D,G), the Nash equilibrium at D(x)=1/2, and why training searches for a saddle point.', readTime: 16 },
      { id: 'gan-m3',   title: 'Training Dynamics & the Non-Saturating Loss',  file: 'gan-m3.html',   description: 'Vanishing gradients from an early, confident discriminator, and the -log D(G(z)) fix almost every implementation uses.', readTime: 15 },
      { id: 'gan-m4',   title: 'Mode Collapse & Training Instability',         file: 'gan-m4.html',   description: 'Why per-sample discrimination misses collapsed diversity, and how minibatch discrimination catches it.', readTime: 15 },
      { id: 'gan-m5',   title: 'DCGAN — Convolutional Architecture Guidelines', file: 'gan-m5.html',  description: 'Strided/transposed convolutions instead of pooling, BatchNorm placement, and the rest of the recipe that stabilized image GANs.', readTime: 18 },
      { id: 'gan-m6',   title: 'Wasserstein GAN & Gradient Penalty',           file: 'gan-m6.html',   description: 'Why JS divergence stalls on disjoint supports, the Wasserstein fix, and enforcing the critic\'s Lipschitz constraint.', readTime: 18 },
      { id: 'gan-m7',   title: 'Conditional GANs',                             file: 'gan-m7.html',   description: 'Conditioning both G and D on a label for targeted generation, and why the label must reach both networks.', readTime: 14 },
      { id: 'gan-m8',   title: 'CycleGAN — Unpaired Image-to-Image Translation', file: 'gan-m8.html', description: 'Two coupled generators, the cycle-consistency loss, and why adversarial loss is still required to avoid the identity-mapping trap.', readTime: 16 },
      { id: 'gan-m9',   title: 'Evaluating GANs — Inception Score & FID',      file: 'gan-m9.html',   description: 'Borrowing a pretrained classifier\'s opinion, and why FID catches mode collapse that Inception Score can miss.', readTime: 16 },
      { id: 'gan-m10',  title: 'Demonstration — DCGAN in PyTorch',            file: 'gan-m10.html',  description: 'Generator, Discriminator, and the full non-saturating training loop, end to end on Fashion-MNIST.', readTime: 18 },
      { id: 'gan-m11',  title: 'GANs in Context — Comparison & What\'s Next',  file: 'gan-m11.html', description: 'DCGAN, WGAN, conditioning, and CycleGAN as independent dials, latent-space smoothness, and where GANs still win.', readTime: 16 },
      { id: 'gan-quiz', title: 'Track Quiz — Generative Adversarial Networks', file: 'gan-quiz.html', description: '16 questions plus 3 multi-selects — the minimax game, non-saturating loss, mode collapse, DCGAN, WGAN, conditioning, CycleGAN, and IS/FID.', readTime: 26 },
    ],
  },
  {
    id: 'diffusion',
    ...
    trackPath: 'diffusion',
    modules: [
      { id: 'diffusion-m1',  title: 'From Adversarial Games to Iterative Denoising', file: 'diffusion-m1.html',  description: 'No discriminator, no saddle point — a fixed corruption process and a learned reverse step, trading one fast pass for many stable ones.', readTime: 14 },
      { id: 'diffusion-m2',  title: 'The Forward (Noising) Process',                 file: 'diffusion-m2.html',  description: 'The Markov chain q(x_t|x_{t-1}) and the closed-form shortcut that samples any x_t from x_0 in one step.', readTime: 16 },
      { id: 'diffusion-m3',  title: 'The Reverse (Denoising) Process',               file: 'diffusion-m3.html',  description: 'Why a small forward step makes the true reverse step approximately Gaussian, and what the learned network predicts.', readTime: 15 },
      { id: 'diffusion-m4',  title: 'Training Objective — From ELBO to Simple Noise Prediction', file: 'diffusion-m4.html', description: 'A diffusion model as a hierarchical VAE, and how the variational bound collapses to a simple MSE noise-prediction loss.', readTime: 18 },
      { id: 'diffusion-m5',  title: 'The U-Net Denoiser & Timestep Conditioning',    file: 'diffusion-m5.html',  description: 'Reusing the Transfer Learning track\'s U-Net, plus sinusoidal timestep embeddings so one network handles every noise level.', readTime: 16 },
      { id: 'diffusion-m6',  title: 'Sampling — From Pure Noise to an Image',        file: 'diffusion-m6.html',  description: 'Why sampling can\'t use the training shortcut, and the sequential step-by-step cost that results.', readTime: 15 },
      { id: 'diffusion-m7',  title: 'Noise Schedules & DDIM',                         file: 'diffusion-m7.html',  description: 'Linear vs. cosine schedules, and DDIM\'s step-skipping speedup with no retraining required.', readTime: 17 },
      { id: 'diffusion-m8',  title: 'Classifier-Free Guidance',                       file: 'diffusion-m8.html',  description: 'Extrapolating past the conditional prediction, and the guidance-scale trade-off between adherence and diversity.', readTime: 16 },
      { id: 'diffusion-m9',  title: 'Latent Diffusion',                              file: 'diffusion-m9.html',  description: 'Running the whole process in a pretrained autoencoder\'s latent space — the mechanism behind Stable Diffusion.', readTime: 16 },
      { id: 'diffusion-m10', title: 'Demonstration — DDPM in PyTorch',               file: 'diffusion-m10.html', description: 'Forward process, time-conditioned U-Net, the simple loss, and the full training and sampling loops.', readTime: 20 },
      { id: 'diffusion-m11', title: 'Diffusion in Context — Comparison & What\'s Next', file: 'diffusion-m11.html', description: 'The VAE/GAN/Diffusion trilogy compared directly, and why diffusion won on stability despite slower sampling.', readTime: 16 },
      { id: 'diffusion-quiz', title: 'Track Quiz — Diffusion Models',                 file: 'diffusion-quiz.html', description: '16 questions plus 3 multi-selects — forward/reverse processes, the ELBO connection, U-Net conditioning, DDIM, guidance, and latent diffusion.', readTime: 26 },
    ],
  },
  {
    id: 'genai-risks',
    ...
    modules: [
      { id: 'genai-risks-m1',   title: 'What Hallucination Means in a GenAI Context',  file: 'genai-risks-m1.html',   description: 'Fluency decoupled from truth, why it is neither lying nor a bug, and why it is a rate to manage rather than a defect to fix.', readTime: 14 },
      { id: 'genai-risks-m2',   title: 'Classifying Hallucinations',                    file: 'genai-risks-m2.html',   description: 'Intrinsic vs extrinsic, faithfulness vs factuality, open vs closed domain, and severity as an independent fourth axis.', readTime: 16 },
      { id: 'genai-risks-m3',   title: 'Why They Occur — the Training Stage',           file: 'genai-risks-m3.html',   description: 'Long-tail sparsity, noisy corpora, the invisible knowledge cutoff, and how preference tuning rewards confidence over hedging.', readTime: 16 },
      { id: 'genai-risks-m4',   title: 'Why They Occur — Model & Inference',            file: 'genai-risks-m4.html',   description: 'Sampling stochasticity, error snowballing, long-context degradation, and the missing architectural abstention state.', readTime: 17 },
      { id: 'genai-risks-m5',   title: 'The Risks — Trust and Real-World Impact',       file: 'genai-risks-m5.html',   description: 'The calibration gap, automation bias eroding human review, and per-step reliability compounding across agent chains.', readTime: 16 },
      { id: 'genai-risks-m6',   title: 'Layered Mitigation in Production',              file: 'genai-risks-m6.html',   description: 'Grounding, decoding constraints, self-consistency, citation checks, guardrails, human review — and designing for the residue.', readTime: 18 },
      { id: 'genai-risks-m7',   title: 'How LLMs Interpret and Prioritise Instructions', file: 'genai-risks-m7.html',  description: 'The instruction hierarchy as a learned preference over one flat sequence, and why wording alone can never make it categorical.', readTime: 16 },
      { id: 'genai-risks-m8',   title: 'Injection and Jailbreaking in Practice',        file: 'genai-risks-m8.html',   description: 'Who the adversary is: a content-policy problem versus a systems-security problem, and why provenance is the real issue.', readTime: 15 },
      { id: 'genai-risks-m9',   title: 'Direct and Indirect Injection Techniques',      file: 'genai-risks-m9.html',   description: 'Payloads in the user turn versus in ingested content, why hidden text passes human review, and why signature filtering fails.', readTime: 18 },
      { id: 'genai-risks-m10',  title: 'Why It Is Serious, and Where It Arises',        file: 'genai-risks-m10.html',  description: 'The confused-deputy problem, exfiltration without a tool call, and risk as untrusted input times unsupervised capability.', readTime: 17 },
      { id: 'genai-risks-m11',  title: 'Layered Mitigation in Responsible Design',      file: 'genai-risks-m11.html',  description: 'Least privilege, privilege separation, human confirmation, egress control, spotlighting — and why resistance is operational.', readTime: 18 },
