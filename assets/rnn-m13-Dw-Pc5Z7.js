import{r as y,j as e,u as f,B as v,R as u,C as j,D as N,a as b,Q as _,M as k}from"./index-WYRBR6CI.js";import{P as p}from"./PredictReveal-DnF7AdIF.js";import{A as T,a as M,B as z}from"./ui-B8T98xz3.js";const o="#0f766e",x="#b45309",m=["the","bank","was","steep","and","muddy"],c=1,w={forward:{fwd:!0,bwd:!1,note:'Reading left to right, position 2 has seen only "the". Nothing so far distinguishes a river bank from a savings bank, and the word that settles it is still four positions away.'},backward:{fwd:!1,bwd:!0,note:'Reading right to left, position 2 has seen "muddy", "and" and "steep" — which settles it immediately. On its own, though, this pass knows nothing of what came before.'},bidirectional:{fwd:!0,bwd:!0,note:"Both passes run over the whole sentence and their states are concatenated, so every position sees the full context. The cost is that the sentence must be complete before either pass finishes, which rules this out for generating text one token at a time."}},S=Object.keys(w);function L(){const[n,s]=y.useState("forward"),a=w[n],t=74,h=6,i=10;return e.jsx(T,{value:o,children:e.jsxs("div",{children:[e.jsx(M,{style:{marginBottom:"0.6rem"},children:S.map(l=>e.jsx(z,{onClick:()=>s(l),primary:n===l,children:l},l))}),e.jsx("div",{style:{overflowX:"auto"},children:e.jsxs("svg",{width:m.length*(t+h)+20,height:120,role:"img","aria-label":a.note,children:[e.jsxs("defs",{children:[e.jsx("marker",{id:"biF",viewBox:"0 0 10 10",refX:"8",refY:"5",markerWidth:"6",markerHeight:"6",orient:"auto-start-reverse",children:e.jsx("path",{d:"M2 1L8 5L2 9",fill:"none",stroke:o,strokeWidth:1.8,strokeLinecap:"round"})}),e.jsx("marker",{id:"biB",viewBox:"0 0 10 10",refX:"8",refY:"5",markerWidth:"6",markerHeight:"6",orient:"auto-start-reverse",children:e.jsx("path",{d:"M2 1L8 5L2 9",fill:"none",stroke:x,strokeWidth:1.8,strokeLinecap:"round"})})]}),m.map((l,r)=>{const d=a.fwd&&r<c||a.bwd&&r>c||r===c;return e.jsxs("g",{children:[e.jsx("rect",{x:i+r*(t+h),y:48,width:t,height:26,rx:5,fill:r===c?o:d?"var(--bg-hover)":"transparent",stroke:"var(--border)",opacity:d?1:.35}),e.jsx("text",{x:i+r*(t+h)+t/2,y:65,fontSize:12,textAnchor:"middle",fill:r===c?"#fff":"var(--text)",opacity:d?1:.35,children:l})]},r)}),a.fwd&&e.jsx("line",{x1:i+6,y1:38,x2:i+(m.length-1)*(t+h)+t-6,y2:38,stroke:o,strokeWidth:1.8,markerEnd:"url(#biF)"}),a.bwd&&e.jsx("line",{x1:i+(m.length-1)*(t+h)+t-6,y1:90,x2:i+6,y2:90,stroke:x,strokeWidth:1.8,markerEnd:"url(#biB)"}),a.fwd&&e.jsx("text",{x:i,y:30,fontSize:10,fill:o,children:"forward pass"}),a.bwd&&e.jsx("text",{x:i,y:108,fontSize:10,fill:x,children:"backward pass"})]})}),e.jsx("p",{style:{fontSize:"0.78rem",color:"var(--text-muted)",marginTop:"0.5rem",lineHeight:1.6},children:a.note})]})})}function g(n){const s={annotation:"annotation",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",math:"math",mi:"mi",mn:"mn",mo:"mo",mover:"mover",mrow:"mrow",msub:"msub",p:"p",path:"path",pre:"pre",semantics:"semantics",span:"span",strong:"strong",svg:"svg",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...f(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.h1,{children:"Module 13: Time Series & Sequence Classification"}),`
`,e.jsx(v,{children:e.jsxs(s.p,{children:[e.jsx(s.strong,{children:"From Module 12:"})," the four sequence patterns are clear. Now let's put them into practice with two concrete use cases — time-series forecasting and sequence classification — with complete PyTorch code you can run and adapt."]})}),`
...
`})}),`
`,e.jsx(s.div,{className:"lesson-visual",role:"region","aria-label":"Bidirectional interactive example; scroll horizontally if needed",tabIndex:"0",children:e.jsx(L,{})}),`
...
`,e.jsx(s.hr,{}),`
`,e.jsx(j,{title:"TL;DR",children:e.jsxs(s.ul,{children:[`
...
`]})}),`
`,e.jsx(_,{question:"In the TimeSeriesLSTM, why is h_n[-1] used instead of the full output tensor for forecasting?",options:["h_n[-1] is faster to compute than the full output","For many-to-one forecasting, we want a single summary of the full sequence — the last layer's final hidden state — not per-step predictions","The full output contains hidden states from all layers, which would be too large for the linear layer","h_n[-1] automatically accounts for padding while the full output does not"],correct:1}),`
`,e.jsx(k,{question:"Which of these preprocessing steps are important when using an LSTM for time-series data?",options:["Z-score normalisation of input features to zero mean and unit variance","Creating sliding window pairs (input window, forecast horizon) from the raw time series","Sorting all sequences by their value before feeding to the LSTM","Gradient clipping to prevent exploding gradients during training","Using teacher forcing during inference to improve forecast accuracy"],correct:[0,1,3]})]})}function C(n={}){const{wrapper:s}={...f(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(g,{...n})}):g(n)}export{C as default};
