...
`})}),e.jsxs(n.p,{children:["Concatenating 8 heads of dimension 64 gives back exactly ",e.jsx(n.code,{children:"embed_dim=512"})," — by design, so a multi-head block's output can be added straight back onto the residual stream, the same shape it started with. The final ",e.jsx(n.code,{children:"out_proj"})," linear layer is Module 6's up-projection for every head at once: each head's ",e.jsx(n.code,{children:"Wv"})," is the down-projection, and ",e.jsx(n.code,{children:"out_proj"})," maps the concatenated small outputs back to ",e.jsx(n.code,{children:"embed_dim"})," while mixing information across heads."]})]}),`
`,e.jsx(n.hr,{}),`
