import{u as o,j as e,C as s,B as a,D as d,a as r,R as c,Q as l}from"./index-COnZx3Nm.js";function i(t){const n={code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{children:"Data Quality & Invalid Values"}),`
...
`,e.jsx(s,{title:"Missing vs. invalid: two different failure modes",children:e.jsxs(n.p,{children:["A ",e.jsx(n.strong,{children:"missing"})," value is absent — ",e.jsx(n.code,{children:"NaN"}),", caught by ",e.jsx(n.code,{children:".isna()"}),". An ",e.jsx(n.strong,{children:"invalid"})," value is present but violates a domain rule specific to what the column means: a fare can't be negative, a rate code must come from a documented set. Catching the second kind requires knowing the business rules of the data, not just calling a generic pandas method."]})}),`
`,e.jsx(a,{children:e.jsx(n.p,{children:"This dataset is NYC taxi trips, so the domain constraints are concrete: fares can't be negative; a zero-distance trip charged a real fare is suspicious (not impossible — a canceled ride can still trigger a minimum charge); and rate codes outside the documented set are worth a sanity check."})}),`
...
`,e.jsxs(d,{children:[e.jsx(r,{number:1,title:"fare_amount < 0 — a fare can't be negative",children:e.jsx(n.p,{children:"A taxi fare is a charge for a service rendered; it cannot be less than zero. Any row here is a data error — likely a refund or billing-reversal record that leaked into the fare column instead of being modeled separately."})}),e.jsx(r,{number:2,title:"(trip_distance == 0) & (fare_amount > 0) — paid for a trip that didn't move",children:e.jsxs(n.p,{children:["Not impossible — a canceled ride can still trigger a minimum charge — but worth flagging. Compare against a row where both ",e.jsx(n.code,{children:"trip_distance"})," and ",e.jsx(n.code,{children:"fare_amount"})," are zero: that's a true non-event, not a data error."]})}),e.jsx(r,{number:3,title:"RatecodeID outside 1-6 — an undocumented category",children:e.jsx(n.p,{children:"The NYC TLC documents rate codes 1 through 6 (standard, JFK, Newark, Nassau/Westchester, negotiated fare, group ride). A value outside that set — or unexpectedly missing — means the column needs a closer look before it's trusted in any groupby."})})]}),`
...
`,e.jsx(a,{children:e.jsx(n.p,{children:"Reading these prints one constraint at a time is fine for a report. The widget below lets you stack all three rules live and watch exactly which rows survive."})}),`
...
`]}),`
`,e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx(n.strong,{children:`What's next: when "wrong" becomes a matter of degree.`}),` Invalid values here were caught with a hard boolean rule — a fare is either negative or it isn't. But how far is "too far" before a `,e.jsx(n.em,{children:"positive"}),", plausible-looking value still counts as wrong? Module 4 makes that boundary statistical: the IQR method."]})}),`
...
`,e.jsx(l,{question:"Which operator performs element-wise logical AND on two pandas boolean Series?",options:["and","or","&","+"],correct:2})]})}function u(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{u as default};
