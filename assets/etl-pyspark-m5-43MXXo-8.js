import{u as r,j as e,R as s,C as i,B as o,Q as l}from"./index-WYRBR6CI.js";import{P as d}from"./PredictReveal-DnF7AdIF.js";function t(a){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{children:"Module 5: Querying with PySpark SQL"}),`
...
`,e.jsxs(d,{prompt:"You can write the same aggregation as a chain of DataFrame method calls or as a SQL string. Do the two run differently?",options:["Yes, SQL is interpreted and therefore slower","No — both compile to the same optimised plan, so the choice is about readability"],correct:1,children:[e.jsx(n.p,{children:"PySpark lets you query DataFrames using standard SQL. The first step is to register a DataFrame as a temporary view, which makes it accessible by name in SQL statements."}),e.jsxs(n.ul,{children:[`
...
result.show()
`})})]}),`
`,e.jsx(s,{items:[{q:"Is there a performance difference between the SQL and DataFrame interfaces?",a:"No. Both are parsed into the same logical plan and handed to the same optimiser, so identical logic produces identical execution. The choice is about which form expresses the intent more clearly and who on the team has to read it."}]}),`
...
result.show()
`})}),`
`,e.jsx(o,{children:e.jsx(n.p,{children:"SQL and the DataFrame API cover most data operations. But sometimes you need custom logic — a calculation or classification that doesn't exist as a built-in function. That's where User-Defined Functions come in."})}),`
