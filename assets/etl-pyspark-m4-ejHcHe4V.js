import{u as t,j as e,R as s,C as i,B as d,Q as o}from"./index-WYRBR6CI.js";import{P as l}from"./PredictReveal-DnF7AdIF.js";function r(a){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...t(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{children:"Module 4: DataFrames: PySpark vs Pandas"}),`
...
`})}),`
`,e.jsx(d,{children:e.jsx(n.p,{children:"DataFrames give us a structured, optimized API. But sometimes you want to query data using familiar SQL syntax instead of method chains. Next, we'll register DataFrames as SQL tables and query them directly."})}),`
...
`,e.jsx(o,{question:"When would you choose PySpark over Pandas?",options:["Dataset fits in RAM on one machine","Dataset is 500GB across a cluster","You need interactive plotting","You need fast iteration in a notebook"],correct:1})]})}function p(a={}){const{wrapper:n}={...t(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(r,{...a})}):r(a)}export{p as default};
