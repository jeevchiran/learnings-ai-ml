import{u as i,j as e,C as a,B as r,D as l,a as c,Q as h,R as o,M as d}from"./index-COnZx3Nm.js";function t(n){const s={annotation:"annotation",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",math:"math",mi:"mi",mn:"mn",mo:"mo",mover:"mover",mrow:"mrow",msub:"msub",p:"p",path:"path",pre:"pre",semantics:"semantics",span:"span",strong:"strong",svg:"svg",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.h1,{children:"Module 13: Time Series & Sequence Classification"}),`
`,e.jsx(a,{title:"TL;DR",children:e.jsxs(s.ul,{children:[`
...
`]})}),`
`,e.jsx(r,{children:e.jsxs(s.p,{children:[e.jsx(s.strong,{children:"From Module 12:"})," the four sequence patterns are clear. Now let's put them into practice with two concrete use cases — time-series forecasting and sequence classification — with complete PyTorch code you can run and adapt."]})}),`
...
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-python",children:`def create_windows(series, window=30, horizon=7):
...
`})}),`
`,e.jsx(a,{title:"Normalisation is critical for time series",children:e.jsx(s.p,{children:"LSTMs are sensitive to input scale. If your signal ranges from 0 to 10,000, the weight matrices must compensate — this makes optimisation harder. Always normalise to zero mean and unit variance (z-score), or scale to [0, 1]. The forecast outputs will be in normalised space; multiply by std and add mean to recover the original scale."})}),`
...
`,e.jsx(s.h3,{children:"Architecture"}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-python",children:`class SequenceClassifier(nn.Module):
