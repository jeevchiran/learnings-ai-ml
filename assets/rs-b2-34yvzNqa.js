import{u as i,j as e,R as a,C as t,B as l,Q as c}from"./index-WYRBR6CI.js";import{P as h}from"./PredictReveal-DnF7AdIF.js";import{R as m}from"./RankingMetricsWidget-BqDfSC06.js";import"./recsysUtils-DhJNCk3B.js";function r(n){const s={annotation:"annotation",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",hr:"hr",li:"li",math:"math",mi:"mi",mn:"mn",mo:"mo",mrow:"mrow",msub:"msub",p:"p",pre:"pre",semantics:"semantics",span:"span",strong:"strong",ul:"ul",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.h1,{children:"Build — Metrics Harness"}),`
...
`,e.jsxs(h,{prompt:"You write the metric functions and the model in the same sitting. Which should you test first?",options:["The model, it is the interesting part","The metrics — a broken metric makes every later comparison meaningless, and it fails silently"],correct:1,children:[e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-python",children:`import numpy as np, pandas as pd
...
`})}),e.jsx(s.p,{children:"Three details that are bugs if you get them wrong:"}),e.jsxs(s.ul,{children:[`
...
`]})]}),`
`,e.jsx(a,{items:[{q:"Why build and test the metric harness before any model?",a:"Every decision that follows is a comparison of numbers the harness produces. If it is wrong, every comparison is wrong and nothing downstream can be trusted, yet it fails quietly rather than crashing. Testing it against hand-computed cases first makes everything after it interpretable."}]}),`
...
`,e.jsx(s.div,{className:"lesson-visual",role:"region","aria-label":"Ranking Metrics interactive example; scroll horizontally if needed",tabIndex:"0",children:e.jsx(m,{})}),`
...
`,e.jsx(l,{children:e.jsx(s.p,{children:"The scoreboard exists. Now put something on it — the baselines any model must beat."})}),`
