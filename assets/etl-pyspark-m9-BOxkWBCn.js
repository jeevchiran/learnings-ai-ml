import{r as k,j as e,u as w,B as _,b as a,R as u,C as g,Q as B}from"./index-WYRBR6CI.js";import{P as f}from"./PredictReveal-DnF7AdIF.js";const i="#f59e0b",c="#dc2626",x=[{key:"map",label:"map / filter",wide:!1,note:"Narrow — each output partition depends on one input partition. No data crosses the network."},{key:"groupby",label:"groupBy / join",wide:!0,note:"Wide — rows with the same key must meet, so partitions are re-shuffled across the network. Expensive."},{key:"repartition",label:"repartition",wide:!0,note:"Wide — deliberately redistributes rows across new partitions. A full shuffle."}];function S(){const[s,n]=k.useState("map"),o=x.find(t=>t.key===s),y=380,b=180,d=60,l=320,h=[40,90,140],m=[];return h.forEach((t,r)=>h.forEach((v,p)=>{(o.wide||r===p)&&m.push({iy:t,oy:v,cross:r!==p})})),e.jsxs("div",{children:[e.jsx("div",{style:{display:"flex",gap:"0.4rem",marginBottom:"0.7rem",flexWrap:"wrap"},children:x.map(t=>e.jsx("button",{onClick:()=>n(t.key),style:{padding:"0.24rem 0.7rem",borderRadius:4,fontSize:"0.78rem",fontFamily:"monospace",cursor:"pointer",fontWeight:s===t.key?700:400,border:`2px solid ${s===t.key?i:"var(--border)"}`,background:s===t.key?i:"var(--bg)",color:s===t.key?"#fff":"var(--text)"},children:t.label},t.key))}),e.jsx("div",{style:{overflowX:"auto"},children:e.jsxs("svg",{width:y,height:b,style:{display:"block",minWidth:300},children:[e.jsx("text",{x:d,y:16,textAnchor:"middle",fontSize:"10",fill:"var(--text-muted)",children:"input partitions"}),e.jsx("text",{x:l,y:16,textAnchor:"middle",fontSize:"10",fill:"var(--text-muted)",children:"output partitions"}),m.map((t,r)=>e.jsx("line",{x1:d+22,y1:t.iy,x2:l-22,y2:t.oy,stroke:t.cross?c:i,strokeWidth:t.cross?1.5:2,opacity:t.cross?.6:.9,strokeDasharray:t.cross?"4,3":"none",style:{transition:"all 0.3s"}},r)),h.map((t,r)=>e.jsxs("g",{children:[e.jsx("rect",{x:d-22,y:t-14,width:44,height:28,rx:4,fill:`${i}cc`}),e.jsxs("text",{x:d,y:t+4,textAnchor:"middle",fontSize:"10",fill:"#fff",children:["P",r+1]})]},"in"+r)),h.map((t,r)=>e.jsxs("g",{children:[e.jsx("rect",{x:l-22,y:t-14,width:44,height:28,rx:4,fill:o.wide?`${c}cc`:`${i}cc`}),e.jsxs("text",{x:l,y:t+4,textAnchor:"middle",fontSize:"10",fill:"#fff",children:["P",r+1]})]},"out"+r))]})}),e.jsxs("div",{style:{marginTop:"0.4rem",background:"var(--bg-hover)",borderLeft:`3px solid ${o.wide?c:i}`,padding:"0.5rem 0.8rem",borderRadius:"0 4px 4px 0",fontSize:"0.82rem"},children:[e.jsxs("strong",{style:{color:o.wide?c:i},children:[o.wide?"Wide":"Narrow"," transformation:"]})," ",o.note]}),e.jsx("p",{style:{fontSize:"0.78rem",color:"var(--text-muted)",marginTop:"0.4rem"},children:"Shuffles dominate Spark job cost. Minimizing wide transformations — and broadcasting small tables in joins — is the core of tuning."})]})}function j(s){const n={code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...w(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{children:"Transformation Operations"}),`
`,e.jsx(_,{children:e.jsx(n.p,{children:"In Module 8, we explored our clean dataset — examining distributions, statistics, and cross-tabulations. Now we reshape it: joining tables, aggregating values, pivoting, and ranking."})}),`
`,e.jsx(n.h2,{children:"Joins"}),`
`,e.jsxs(f,{prompt:"A join between two large distributed tables is usually the slowest step in a pipeline. What makes it expensive?",options:["Comparing every row against every other row","The shuffle — matching keys must be moved onto the same machine, which means sending data across the network"],correct:1,children:[e.jsx(n.p,{children:"Joins combine rows from two DataFrames based on a shared key column."}),e.jsxs(n.table,{children:[e.jsx(n.thead,{children:e.jsxs(n.tr,{children:[e.jsx(n.th,{children:"Join type"}),e.jsx(n.th,{children:"Returns"})]})}),e.jsxs(n.tbody,{children:[e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"inner"})}),e.jsx(n.td,{children:"Only rows with key in both DataFrames"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"left"})}),e.jsx(n.td,{children:"All rows from left; unmatched right rows get nulls"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"right"})}),e.jsx(n.td,{children:"All rows from right; unmatched left rows get nulls"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"full"})}),e.jsx(n.td,{children:"All rows from both; unmatched sides get nulls"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"anti"})}),e.jsx(n.td,{children:"Rows from left with NO match in right"})]})]})]}),e.jsx(a,{language:"python",children:`# Inner join — only matching rows from both sides
...
no_enrollments.show()`})]}),`
`,e.jsx(u,{items:[{q:"Why is a join between two large distributed tables expensive?",a:"Rows sharing a key can start out on different machines, so the engine must redistribute both sides by key before matching, which sends data across the network and writes it to disk. That redistribution, the shuffle, dominates the cost and is why a small table is broadcast instead whenever it fits."}]}),`
...
`,e.jsxs(f,{prompt:"You want each row alongside its group's average, keeping every original row. Does a groupBy do that?",options:["Yes, that is what grouping is for","No — grouping collapses each group to one row, so you need a window function to keep the rows and add the aggregate"],correct:1,children:[e.jsxs(n.p,{children:["Window functions compute values across related rows ",e.jsx(n.strong,{children:"without collapsing groups"}),". You define a window spec (partition + order), then apply ranking or analytic functions over it."]}),e.jsxs(n.table,{children:[e.jsx(n.thead,{children:e.jsxs(n.tr,{children:[e.jsx(n.th,{children:"Function"}),e.jsx(n.th,{children:"Behavior"})]})}),e.jsxs(n.tbody,{children:[e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"row_number()"})}),e.jsx(n.td,{children:"Unique sequential number within partition"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"rank()"})}),e.jsx(n.td,{children:"Rank with gaps for ties (1, 2, 2, 4)"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"dense_rank()"})}),e.jsx(n.td,{children:"Rank without gaps (1, 2, 2, 3)"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"lag(col, n)"})}),e.jsx(n.td,{children:"Value from n rows before current"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"lead(col, n)"})}),e.jsx(n.td,{children:"Value from n rows after current"})]})]})]}),e.jsx(n.h3,{children:"Ranking students by GPA within major"}),e.jsx(a,{language:"python",children:`from pyspark.sql.window import Window
...
# |   Eva|   DS|3.7|   1|
# |   Bob|   DS|3.5|   2|
# +------+-----+---+----+`}),e.jsx(n.h3,{children:"Using lag() to compare adjacent rows"}),e.jsx(a,{language:"python",children:`from pyspark.sql.functions import lag
...
`,e.jsx(u,{items:[{q:"What does a window function do that a groupBy cannot?",a:"It computes an aggregate over a group while keeping every original row, attaching the group's value to each of them. A groupBy collapses each group to a single row, so any per-row detail is lost and would have to be joined back."}]}),`
`,e.jsx(n.div,{className:"lesson-visual",role:"region","aria-label":"Shuffle interactive example; scroll horizontally if needed",tabIndex:"0",children:e.jsx(S,{})}),`
...
`,e.jsx(n.hr,{}),`
`,e.jsx(g,{title:"TL;DR",children:e.jsxs(n.ul,{children:[`
...
`]})}),`
`,e.jsx(B,{question:"You want to find all students who have NO enrollments. Which join type gives you this result?",options:["Left join, then filter where enrollment columns are null","Anti join — returns rows from the left DataFrame that have no match in the right","Inner join, then negate the result","Full outer join, then filter where right side is null"],correct:1})]})}function A(s={}){const{wrapper:n}={...w(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(j,{...s})}):j(s)}export{A as default};
