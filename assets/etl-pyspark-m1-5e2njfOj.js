import{u as a,j as e,C as r,B as o,R as i,Q as d}from"./index-COnZx3Nm.js";function t(s){const n={code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...a(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"TL;DR",children:e.jsxs(n.ul,{children:[`
...
`})}),`
`,e.jsx(o,{children:e.jsx(n.p,{children:"Next up: Now that we can extract, transform, and load data, we'll explore why Spark keeps this data in memory — and what makes that so powerful."})}),`
...
`,e.jsx(d,{question:"In the ETL pipeline, which step involves filtering rows and adding computed columns?",options:["Extract","Transform","Load","Ingest"],correct:1})]})}function c(s={}){const{wrapper:n}={...a(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{c as default};
