...
`,e.jsx(t.li,{children:"The translation example here uses an encoder-decoder: one stack represents the source and another generates the target. Decoder-only models can also translate by conditioning on a source in the prompt; an encoder alone needs an added generation mechanism."}),`
